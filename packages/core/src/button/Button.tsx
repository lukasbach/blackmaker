...
export const Button = React.forwardRef<HTMLButtonElement | HTMLAnchorElement, React.PropsWithChildren<ButtonProps>>(
  (componentProps, ref) => {
    useEffect(() => {
    ...
    const backgroundColorHoverSign = new Color(backgroundColor).lighten(0.17).lightness() === 100 ? -1 : 1;
