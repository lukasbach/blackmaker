  ...
  <div>
    { intents.map(intent => (
      <div key={intent}>
        ...
        <Heading intent={intent} level={2}>Heading second level (h2)</Heading>
        <Heading intent={intent} level={3}>Heading third level (h3)</Heading>
        <Heading intent={intent} level={4}>Heading forth level (h4)</Heading>
        <Heading intent={intent} level={5}>Heading fifth level (h5)</Heading>
        <Heading intent={intent} level={6}>Heading sixth level (h6)</Heading>
      </div>
    )) }
  </div>
)
