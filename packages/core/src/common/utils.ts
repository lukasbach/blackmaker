...
export const switchEnum = <Type, Return>(
  e: Type,
  possibilities: Array<[Type, Return]>,
  defaultValue?: Return // TODO make typesafe if e can be undefined, this may not be undefined
): Return => {
